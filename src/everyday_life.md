...
اگر از پلتفرم ویندوز یا مکینتاش به لینوکس مهاجرت می‌کنید، شاید متعجب شوید اگر برنامه‌هایی که قبلاً استفاده می‌کردید برای لینوکس هم موجود باشند. بعضی از نرم‌افزارهایی که هم‌اکنون استفاده می‌کنید نسخه‌های لینوکسی دارند. برای آن دسته که به این شکل نیستند برنامه‌های آزاد و متن بازی موجود هست که نیازهای شما را پوشش می‌دهند. در این بخش نرم‌افزارهایی را معرفی می‌کنیم که به خوبی روی لینوکس کار می‌کنند:
