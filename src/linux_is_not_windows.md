...
کاربران ویندوز - حداقل در صورتی که نرم افزار را ندزدیده باشند - یک رابطه مشتری و فروشنده با ارائه دهنده سرویس دارند. آن‌ها برای نرم‌افزار، گارانتی، پشتیبانی و هر چیز دیگر پول می‌دهند. آن‌ها انتظار دارند که نرم افزاری که خریده اند تا حد قابل قبولی درست کار کند و نسبت به آن احساس حق می‌کنند: آن‌ها پول داده‌اند و حق دارند که آن را کامل و با پشتیبانی دائمی تحویل بگیرند. در عین حال طرف حساب آن‌ها شرکت ها هستند نه افراد.
...
![](images/compizshot.png)یک مساله جدی. عبارت کاربرپسند یا User Friendly آنقدر مهم است که یکی از سایت‌های کاریکاتور بسیار مشهور هم اسمش را همین گذاشته (در ایران فیلتر است، چون در مورد برنامه نویسی است). اما این عبارت، عبارت ناجوری است.
...
![](images/Apple_Macintosh_Desktop.png)<br>اپل در ۱۹۸۴
...
![](images/X-Window-System.png)<br>یونیکس مجهز به X در ۱۹۹۰
